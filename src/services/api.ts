...
const initialProducts: Product[] = [
    {
      ...
      timeline: [
        ...
        { title: 'Bàn ăn', desc: 'Sẵn sàng cho người tiêu dùng thưởng thức.', date: '20/09/2025', location: 'Cửa hàng bán lẻ' },
      ],
      inStock: true,
      quantity: 500,
    ...
    },
    {
      ...
      timeline: [
        ...
        { title: 'Bàn ăn', desc: 'Tươi ngon cho bữa ăn gia đình.', date: '24/08/2025', location: 'Người tiêu dùng' },
      ],
      inStock: true,
      quantity: 1000,
    ...
    },
    {
      ...
      timeline: [
        ...
        { title: 'Bàn ăn', desc: 'Ngọt ngon cho người dùng.', date: '14/09/2025', location: 'Cửa hàng bán lẻ' },
      ],
      inStock: false,
      quantity: 0,
    ...
    },
    {
      ...
      timeline: [
        ...
        { title: 'Bàn ăn', desc: 'Tươi ngon, bổ dưỡng.', date: '14/06/2025', location: 'Người tiêu dùng' },
      ],
      inStock: true,
      quantity: 200,
    ...
    },
    {
      ...
      timeline: [
        ...
        { title: 'Bàn ăn', desc: 'Hương vị đặc trưng, thơm ngon.', date: '24/07/2025', location: 'Người tiêu dùng' },
      ],
      inStock: true,
      quantity: 300,
    ...
    },
    {
      ...
      timeline: [
        ...
        { title: 'Bàn ăn', desc: 'Tươi ngon, bổ dưỡng.', date: '19/04/2025', location: 'Người tiêu dùng' },
      ],
      inStock: true,
      quantity: 800,
    ...
    },
    {
      ...
      timeline: [
        ...
        { title: 'Bàn ăn', desc: 'Ngọt, mọng nước.', date: '14/05/2025', location: 'Người tiêu dùng' },
      ],
      inStock: true,
      quantity: 400,
    ...
    },
    {
      ...
      timeline: [
        ...
        { title: 'Bàn ăn', desc: 'Tươi ngon cho bữa ăn.', date: '19/02/2025', location: 'Người tiêu dùng' },
      ],
      inStock: true,
      quantity: 1200,
    ...
    },
    {
      ...
      timeline: [
        ...
        { title: 'Bàn ăn', desc: 'Thơm ngon, béo bùi.', date: '14/03/2025', location: 'Người tiêu dùng' },
      ],
      inStock: true,
      quantity: 600,
    ...
    },
    {
      ...
      timeline: [
        ...
        { title: 'Bàn ăn', desc: 'Ngọt, mọng nước.', date: '14/02/2025', location: 'Người tiêu dùng' },
      ],
      inStock: true,
      quantity: 500,
    ...
    },
    {
      ...
      timeline: [
        ...
        { title: 'Bàn ăn', desc: 'Giòn, ngọt, bổ dưỡng.', date: '19/01/2025', location: 'Người tiêu dùng' },
      ],
      inStock: true,
      quantity: 900,
    ...
    },
    {
      ...
      timeline: [
        ...
        { title: 'Bàn ăn', desc: 'Ngọt, mọng nước.', date: '14/12/2024', location: 'Người tiêu dùng' },
      ],
      inStock: true,
      quantity: 700,
