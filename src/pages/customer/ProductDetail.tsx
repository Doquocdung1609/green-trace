...
//             <Button
//               onClick={addToCart}
//               className="rounded-full bg-green-600 hover:bg-green-700 text-white px-8 py-3 text-lg font-semibold shadow-md hover:shadow-lg transition-all"
//             >
//               💰 Đầu tư ngay
//             </Button>
//           </motion.div>
...
//                 <QRViewer
//                   value={`https://solanaexplorer.io/tx/${product.blockchainTxId}`}
//                 />
//               </div>
//             </motion.div>
//           </TabsContent>
